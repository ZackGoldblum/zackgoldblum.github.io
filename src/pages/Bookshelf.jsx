...
function Bookshelf() {
    ...
    const bookshelfData = {
        ...
        "2025-2026": [
            ...
            { title: "Nemesis Games", author: "James S.A. Corey", imageSrc: "/books/nemesis_games.webp", rating: 4, size: "M", titlePadTop: 22 },
            { title: "Cibola Burn", author: "James S.A. Corey", imageSrc: "/books/cibola_burn.webp", rating: 4, size: "M", titlePadTop: 22 },
            ...
            { title: "Zero to One", author: "Peter Thiel", imageSrc: "/books/zero_to_one.webp", rating: 4.5, size: "M", titlePadTop: 22 },
            { title: "Sleep and the Soul", author: "Greg Egan", imageSrc: "/books/sleep_and_the_soul.webp", rating: 3.5, size: "M", titlePadTop: 10 },
            { title: "The Techno-Optimist Manifesto", author: "Marc Andressen", imageSrc: "/books/the_techno-optimist_manifesto.webp", rating: 3.5, size: "M" },
            { title: "The Quantum Thief", author: "Hannu Rajaniemi", imageSrc: "/books/the_quantum_thief.webp", rating: 3.5, size: "M", titlePadTop: 10 },
            ...
            { title: "The Return of the King", author: "J. R. R. Tolkien", imageSrc: "/books/the_return_of_the_king.webp", rating: 5, size: "L", titlePadTop: 22 },
            { title: "The Two Towers", author: "J. R. R. Tolkien", imageSrc: "/books/the_two_towers.webp", rating: 4.5, size: "L", titlePadTop: 32 },
            { title: "The Fellowship of the Ring", author: "J. R. R. Tolkien", imageSrc: "/books/the_fellowship_of_the_ring.webp", rating: 4, size: "L", titlePadTop: 22 },
        ...
        "Earlier Reading": {
            ...
            books: [
                ...
                { title: "Atomic Habits", author: "James Clear", imageSrc: "/books/atomic_habits.webp", size: "XXS", authorBottomPosition: 0, titlePadTop: 10 },
                ...
                { title: "The Body Builders", author: "Adam Piore", imageSrc: "/books/the_body_builders.webp", size: "XS", authorBottomPosition: 16 },
                ...
                { title: "The Metamorphosis", author: "Franz Kafka", imageSrc: "/books/the_metamorphosis.webp", size: "XS", authorBottomPosition: 16 },
                ...
                { title: "Oedipus Rex", author: "Sophocles", imageSrc: "/books/oedipus_rex.webp", size: "XS", titlePadTop: 10, authorBottomPosition: 16 },
                ...
                { title: "Inkdeath", author: "Cornelia Funke", imageSrc: "/books/inkdeath.webp", size: "XS", titlePadTop: 10, authorBottomPosition: 16 },
                { title: "Inkspell", author: "Cornelia Funke", imageSrc: "/books/inkspell.webp", size: "XS", titlePadTop: 10, authorBottomPosition: 16 },
                { title: "Inkheart", author: "Cornelia Funke", imageSrc: "/books/inkheart.webp", size: "XS", titlePadTop: 10, authorBottomPosition: 16 },
                { title: "The Game of Lives", author: "James Dashner", imageSrc: "/books/the_game_of_lives.webp", size: "XS", authorBottomPosition: 16 },
                { title: "The Rule of Thoughts", author: "James Dashner", imageSrc: "/books/the_rule_of_thoughts.webp", size: "XS", authorBottomPosition: 16 },
                { title: "The Eye of Minds", author: "James Dashner", imageSrc: "/books/the_eye_of_minds.webp", size: "XS", titlePadTop: 10, authorBottomPosition: 16 },
                { title: "The Death Cure", author: "James Dashner", imageSrc: "/books/the_death_cure.webp", size: "XS", titlePadTop: 10, authorBottomPosition: 16 },
                { title: "The Scorch Trials", author: "James Dashner", imageSrc: "/books/the_scorch_trials.webp", size: "XS", authorBottomPosition: 16 },
                { title: "The Maze Runner", author: "James Dashner", imageSrc: "/books/the_maze_runner.webp", size: "XS", titlePadTop: 10, authorBottomPosition: 16 },
                { title: "Terminal", author: "Roderick Gordon & Brian Williams", imageSrc: "/books/terminal.webp", size: "XS", titlePadTop: 10, authorBottomPosition: 8 },
                { title: "Spiral", author: "Roderick Gordon & Brian Williams", imageSrc: "/books/spiral.webp", size: "XS", titlePadTop: 10, authorBottomPosition: 8 },
                ...
                { title: "Dust & Decay", author: "Jonathan Maberry", imageSrc: "/books/dust_and_decay.webp", size: "XXS", authorBottomPosition: 6 },
                { title: "Rot & Ruin", author: "Jonathan Maberry", imageSrc: "/books/rot_and_ruin.webp", size: "XXS", authorBottomPosition: 6 },
                { title: "Mockingjay", author: "Suzanne Collins", imageSrc: "/books/mockingjay.webp", size: "XXS", authorBottomPosition: 6 },
                ...
                { title: "Ship Breaker", author: "Paolo Bacigalupi", imageSrc: "/books/ship_breaker.webp", size: "XXS", titlePadTop: 10 },
