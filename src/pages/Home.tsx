    ...
    <div className="home">
      <section className="hero">
        ...
        <p className="hero__lede rise rise--2">
          Hello! Welcome to my corner of the universe. I do cool brain research — engineering and
          science at the intersection of neurotechnology and AI, building devices that listen to
          the brain and learn to talk back.
        </p>
